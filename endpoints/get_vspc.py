...
@app.get("/info/get-vscp-from-block", response_model=VscpResponse, tags=["Kobra network info"])
async def get_virtual_selected_parent_chain_from_block(
    ...
    some startHash to this kobrad's current virtual.
    """
    resp = await kobrad_client.request("getVirtualSelectedParentChainFromBlockRequest",
                                       params={
                                           "startHash": startHash,
