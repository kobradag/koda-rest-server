...
async def submit_a_new_transaction(body: SubmitTransactionRequest):
    """
    Forwards the body directly to kobrad with the command submitTransactionRequest
    """
    tx_resp = await kobrad_client.request("submitTransactionRequest",
                                          params=body.dict())
